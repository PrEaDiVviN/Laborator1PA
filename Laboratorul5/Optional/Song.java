...
public class Song extends Item{
    ...
    public Song(Song from) {
        super(from.getId(),from.getName(),from.getLocation());
        this.madeByArtist = new String(from.getMadeByArtist());
        this.releaseDate = java.sql.Date.valueOf(from.getReleaseDate().toString());
        this.songDuration = Duration.ofSeconds(from.getSongDuration());
    }
    ...
    public long getSongDuration() {
        return songDuration.getSeconds();
    }
