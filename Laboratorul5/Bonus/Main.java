...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        var imageForest = new Image("ForestImage", "Forest with fog from mountain", "C:\\Users\\PrEaD\\Pictures\\Saved Pictures\\Forest.jpg",
                "A beautiful view of a forest with it's fox. Best for windows wallpaper", "Andrew Carson", Date.valueOf("2012-03-15"), 1280, 720);
        ...
        var songSecond = new Song("GoodSong", "Better Days", "https://www.youtube.com/watch?v=VGP6JP_hAPM&ab_channel=AirwaveMusicTV", Duration.ofSeconds(188),
                Date.valueOf("2019-11-18"), "K-391");
        var bookFantasy = new Book("FantasyBook", "Harry Potter si Piatra Filozofala",
                "C:\\Users\\PrEaD\\Desktop\\Anul2_semestrul2\\PA\\Laboratorul5\\src\\com\\company\\carte.txt", 152, 9.6f,
        ...
        /*
        ///Aplicarea algoritmului greedy pe exemplul initial
        CatalogRepresentationGraph graph = new CatalogRepresentationGraph(catalog);
        graph.generateMatrix();
        Algorithm algorithmGreedy = new GreedyAlgorithm();
        Solution sol = algorithmGreedy.solve(graph);
        System.out.println(sol.getStringBuilderSolution());
         */
        /*
        ///Aplicarea algoritmului greedy pe un graf generat automat
        CatalogRepresentationGraph graph = new GreedyAlgorithmTest().generateRandom(1000);
        GreedyAlgorithmTest test = new GreedyAlgorithmTest();
        Solution sol = test.solve(graph);
        System.out.println(sol.getStringBuilderSolution());

         */
        /*
        ///NOT FUNCTIONAL
        Command cmd = new InfoCommand("FantasyBook");
        try {
            cmd.applyTo(catalog);
        }
        catch (Exception e) {
